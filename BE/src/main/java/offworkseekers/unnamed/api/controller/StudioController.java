...
import offworkseekers.unnamed.api.request.GetStudioNavbarRequest;
...
public class StudioController {
    ...
    public StudioNavBarResponse getStudioNavbar(@RequestBody @Valid GetStudioNavbarRequest request) {
